;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof define === 'function' && define.amd) define(['prop-types'], factory)
  else if (typeof exports === 'object') exports.Dropzone = factory(require('prop-types'))
  else root.Dropzone = factory(root['prop-types'])
    ...
    /** *** */ [
      ...
      /** */ function(module, exports, __webpack_require__) {
        ;(function(process) {
          ...
          const _utils = __webpack_require__(3)

          const _styles = __webpack_require__(5)

          const _styles2 = _interopRequireDefault(_styles)
            ...
            _createClass(Dropzone, [
              ...
              },
              {
                ...
                value: function onDrop(evt) {
                  ...
                  const fileList = (0, _utils.getDataTransferItems)(evt)
                  const acceptedFiles = []
                  const rejectedFiles = []
     ...
     */
              ...
              },
              {
                ...
                value: function render() {
                  ...
                  const isDragAccept =
                    filesCount > 0 && (0, _utils.allFilesAccepted)(draggedFiles, this.props.accept)
  ...
  */
   ...
   */
      ...
      /** */ function(module, exports, __webpack_require__) {
        ...
        const _attrAccept = __webpack_require__(4)
        ...
        const supportMultiple = (exports.supportMultiple =
      ...
      /** */ function(module, exports) {
        module.exports = (function(t) {
          function n(e) {
            ...
            const o = (r[e] = { exports: {}, id: e, loaded: !1 })
          ...
          function(t, n) {
            const r = (t.exports = { version: '1.2.2' })
                ...
                for (a in r)
                  (p = !(t & s.F) && v && a in v),
                    ...
                    (y =
                      t & s.B && p
                        ? f(l, e)
                        : h && typeof l === 'function' ? f(Function.call, l) : l),
                    v && !p && u(v, a, l),
                    x[a] != l && i(x, a, y),
                    h && ((x[c] || (x[c] = {}))[a] = l)
              }
          ...
          function(t, n, r) {
            ...
            ;(r(1).inspectSource = function(t) {
              ...
              (t.exports = function(t, n, r, u) {
                ...
                return (typeof this === 'function' && this[i]) || c.call(this)
              })
          },
          function(t, n, r) {
            let e = r(2),
